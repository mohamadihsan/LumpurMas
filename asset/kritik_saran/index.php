	    ...
	    <section class="content">
	      	<div class="row">
	        	...
	        	<div class="col-md-9">
					...
					$sql = "SELECT id_kritiksaran, tgl_kritiksaran, status_kritiksaran, isi_kritiksaran, id_pelanggan FROM kritiksaran";			
					$stmt = $db->prepare($sql);
					$stmt->execute();

					$stmt->bind_result($id_kritiksaran, $tgl_kritiksaran, $status_kritiksaran, $isi_kritiksaran, $id_pelanggan);
					?>
								...
								<tbody>	
									...
									<tr>
										...
										<?php
											if (($jabatan=="manager")OR($jabatan=="direktur")OR($jabatan=="administrasi")) {
												?>
													<th><center><a href="detail.php?id_kritiksaran=<?php echo $id_kritiksaran;?>"><i class="fa fa-info"></i></a></center></th>
												<?php
											}
											if ($jabatan=="administrasi") {
												?>
													<td><a href="balas.php?id_kritiksaran=<?php echo $id_kritiksaran;?>"><i class="fa fa-pencil"></i> Balas</a></td>
